    ...
    return (
        <>
            ...
            <div className="row">
                <div className="col-lg-2 bg-secondary d-none d-lg-block">
                    ...
                    <h1 className="m-0 display-9 text-primary">
                        YJ & <span className="small-text">Ass.</span>
                    </h1>
                    </Link>
        ...
        <a href="mailto:contact@yashjainandassociates.com?subject=General%20Enquiry">
            ...
            <small>contact@yashjainandassociates.com</small>
        </a>
    </div>
    <div className="h-100 d-inline-flex align-items-center py-2 px-2" onClick={() => window.open('tel:+91-9806204529')}>
